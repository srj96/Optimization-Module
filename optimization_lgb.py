...
class LgbOptimizeMethod:
    
    '''Optimization base class calling other optimization technique namely Grid Search , 
    Bayes Opt and Hyper Opt. Here this class specifically defined for light gbm with parameters
    as n_estimiators , max_depth, min_child_weight, num_leaves and learning rate. Cross Validation
...
if __name__ == "__main__":
    ...
    parser.add_argument("-num_leaves", nargs = '+', type = float)
    parser.add_argument("-min_child_weight", nargs = '+', type = float)
    ...
    model_path = "/home/congnitensor/Python_projects/model_class/file_logs/model_lgb.txt"
    # model_path = "model.txt"

    obj = LgbOptimizeMethod(params = param_list, init_points = init_points , n_iter = num_iter , max_evals = max_evals, cross_val= cross_val, model_path= model_path) 
