...
if __name__ == "__main__":
    ...
    # model_path = "/home/congnitensor/Python_projects/model_class/file_logs/model_svm.txt"
    model_path = "model.txt"

    obj = SvmOptimizeMethod(params = param_list, init_points = init_points , 
