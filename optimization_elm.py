...
if __name__ == "__main__":
    ...
    model_path = "/home/congnitensor/Python_projects/model_class/file_logs/model_elm.txt"
    # model_path = "model.txt"

    obj = ElmOptimizeMethod(params = param_list, init_points = init_points , n_iter = num_iter , max_evals = max_evals, cross_val= cross_val, model_path= model_path) 
